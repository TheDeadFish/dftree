...
/* Left accessors. */
#define rbtn_left_get(a_node) ((a_node)->rbn_left)
#define rbtn_left_set(a_node, a_left) (a_node)->rbn_left = a_left;				\

/* Right accessors. */
#define rbtn_right_get(a_node) ((a_node)->right_get())
#define rbtn_right_set(a_node, a_right) (a_node)->right_set(a_right);

/* Color accessors. */
#define rbtn_red_get(a_node)	\
    (a_node)->red_get()
    
#define rbtn_color_set(a_node, a_red) (a_node)->color_set(a_red)						\

#define rbtn_red_set(a_node) (a_node)->red_set()
#define rbtn_black_set(a_node) (a_node)->black_set()

/* Node initializer. */
#define rbt_node_new(a_rbt, a_node) do {		\
